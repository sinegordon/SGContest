...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.edit_language = QtWidgets.QComboBox(self.centralwidget)
        self.edit_language.setEnabled(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_language.addItem(_translate("MainWindow", "python"), "*.py")
        self.edit_language.addItem(_translate("MainWindow", "c#"), "*.cs")
        ...
        self.spin_variant.setEnabled(False)
