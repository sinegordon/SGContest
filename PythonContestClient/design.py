...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_server)
        self.edit_server = QtWidgets.QLineEdit(self.centralwidget)
        self.edit_server.setObjectName("edit_server")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.edit_server)
        self.label_course = QtWidgets.QLabel(self.centralwidget)
        self.label_course.setObjectName("label_course")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_course)
        ...
        self.buttons_layout.addWidget(self.push_reset)
        self.push_code = QtWidgets.QPushButton(self.centralwidget)
        self.push_code.setObjectName("push_code")
        self.buttons_layout.addWidget(self.push_code)
        self.formLayout.setLayout(8, QtWidgets.QFormLayout.SpanningRole, self.buttons_layout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_server.setText(_translate("MainWindow", "Адрес сервера"))
        self.edit_server.setText(_translate("MainWindow", "http://62.76.72.55:57888"))
        self.label_course.setText(_translate("MainWindow", "Код учебного курса"))
        self.edit_course.setText(_translate("MainWindow", "kate_test"))
        self.label_problem.setText(_translate("MainWindow", "Тестовая задача №"))
        self.label_variant.setText(_translate("MainWindow", "Вариант"))
        self.push_reset.setText(_translate("MainWindow", "Сменить пользователя"))
        ...
        self.spin_variant.setEnabled(True)
